...
> = {
  en: {
    ...
    navAdmin: "Admin area",
    navCta: "Try the demo",
    badge: "9forms.com · Smart Form Builder & Workflows",
    heroH1Pre: "One form platform for",
    heroH1Span: "every industry.",
    heroLead:
      "9forms.com is a conversational form builder — one question at a time, automatic navigation, voice answers, and a clean admin dashboard. From clinics to classrooms, collect better data in minutes.",
    ...
    demo3Badge: "Demo 3 · Senior-Friendly (Dark Contrast)",
    demo3Title: "Senior-Friendly Registration",
    demo3Desc:
    ...
    demo3ResearchLink: "Based on Research Study",
    ...
    adminDesc:
      "Every response lands in a clean workspace: search, filter, update triage statuses and keep names tidy.",
    adminB1: "All submissions in one table",
    adminB2: "Update status in one click",
    adminB3: "Rename respondents safely",
    adminB4: "Fast search and filtering",
    adminCta: "Enter Admin Area",
    ...
    closingTitle: "See 9forms.com through your customers' eyes.",
    closingDesc:
    ...
    footerNote: "9forms.com is a smart form builder & workflow platform.",
  ...
  id: {
    ...
    navAdmin: "Area Admin",
    navCta: "Coba Demo",
    badge: "9forms.com · Pembuat Form Cerdas & Alur Kerja",
    heroH1Pre: "Satu platform formulir untuk",
    heroH1Span: "semua industri.",
    heroLead:
      "9forms.com adalah pembuat formulir percakapan — satu pertanyaan per layar, perpindahan otomatis, jawaban dengan suara, dan dasbor admin yang rapi. Dari klinik hingga kelas, kumpulkan data lebih baik dalam hitungan menit.",
    ...
    mockVoiceTitle: "Mendengarkan — katakan jawaban Anda",
    ...
    proof4Number: "92%",
    proof4Title: "Penyelesaian",
    proof4Sub: "alur terpandu",
    indKicker: "Dibuat untuk semua bidang",
    indTitle1: "Satu pembuat,",
    indTitle2: "banyak industri.",
    indDesc:
      "Rancang formulir terpandu yang mobile-first untuk skenario apa pun — lalu bagikan satu tautan dan lihat jawaban terstruktur masuk ke dasbor Anda.",
    ind1Name: "Kesehatan & Klinik",
    ind1Desc: "Formulir pendaftaran, skrining, & triase pasien.",
    ind2Name: "Pendidikan",
    ind2Desc: "Survei siswa, pendaftaran kelas, kuis.",
    ind3Name: "HR & Rekrutmen",
    ind3Desc: "Lamaran kerja, orientasi karyawan, survei berkala.",
    ind4Name: "Acara & Event",
    ind4Desc: "Pendaftaran tamu, umpan balik sesi.",
    ...
    demo3Badge: "Demo 3 · Ramah Lansia / Senior-Friendly (Dark Kontras)",
    demo3Title: "Pendaftaran Ramah Lansia (Senior-Friendly)",
    demo3Desc:
    ...
    demo3ResearchLink: "Berdasarkan Studi Penelitian (Research Basis)",
    ...
    closingTitle: "Lihat 9forms.com dari mata pelanggan Anda.",
    closingDesc:
    ...
    footerNote: "9forms.com adalah platform pembuat formulir cerdas & alur kerja otomatis.",
  ...
  zh: {
    ...
    navAdmin: "管理后台",
    navCta: "试用演示",
    badge: "9forms.com · 多行业智能表单平台",
    heroH1Pre: "一个表单平台，服务",
    heroH1Span: "所有行业。",
    heroLead:
      "9forms.com 是对话式表单构建工具——一次一题、自动跳转、语音作答，并配备清爽的管理后台。从诊所到课堂，几分钟内收集更优质的数据。",
    ...
    mockOpt2: "腰部或背部酸痛",
    mockOpt3: "肩膀或手臂疼痛",
    mockAuto: "自动跳转——无需点击下一题",
    mockVoiceTitle: "正在聆听——请说出您的回答",
    ...
    indTitle1: "一个构建工具，",
    indTitle2: "服务多种行业。",
    indDesc: "为任何场景设计移动优先的引导式表单——只需分享一个链接，即可在后台查看结构化答卷。",
    ind1Name: "医疗与诊所",
    ind1Desc: "患者初诊登记、分流评估表单。",
    ind2Name: "教育机构",
    ind2Desc: "学生问卷、课程报名、在线测验。",
    ind3Name: "人力与招聘",
    ind3Desc: "求职申请、入职登记、定期反馈。",
    ind4Name: "活动展会",
    ind4Desc: "嘉宾签到、现场调研与评分。",
    ind5Name: "房产中介",
    ind5Desc: "租客申请、预约看房登记。",
    ind6Name: "零售与餐饮",
    ind6Desc: "顾客反馈、订单登记。",
    demoKicker: "在线演示",
    demoTitle1: "像您的客户",
    ...
    demo2F3: "自动生成风险评分",
    demo2Cta: "打开演示 2",
    demo3Badge: "演示 3 · 长者关怀深色版 (Senior-Friendly)",
    demo3Title: "长者关怀初诊登记 (Senior-Friendly)",
    demo3Desc: "高对比度暖炭黑配色，配备超大触控按键、语音应答与清晰直观的字母标识。",
    demo3F1: "暖炭黑与暖金黄高对比度界面",
    demo3F2: "带 A/B 字母标识的超大触控按钮",
    demo3F3: "自动跳转 + 持续语音应答支持",
    demo3Cta: "打开演示 3",
    demo3ResearchLink: "基于学术研究基础 (Based on Research Study)",
    ...
    f1Label: "对话式",
    f1Title: "一屏一个问题。",
    f1Desc: "填写者每次专注于单一决策，从而保持高完成率。",
    f2Label: "自动化",
    f2Title: "自动跳转导航。",
    f2Desc: "作答完成后立即进入下一题——无需费心寻找“下一步”按钮。",
    f3Label: "语音优先",
    f3Title: "语音作答。",
    f3Desc: "开启一次麦克风，后续所有题目自动监听，并可随时手动触控作答。",
    f4Label: "多语言支持",
    f4Title: "EN · Bahasa · 中文.",
    f4Desc: "界面与语音识别自动匹配填写者的语言设置。",
    f5Label: "管理后台",
    f5Title: "团队喜爱的仪表盘。",
    f5Desc: "通过评分、状态和快速筛选查看每份提交——灵感来自现代临床门户。",
    f6Label: "无障碍设计",
    f6Title: "老少皆宜。",
    f6Desc: "长者模式采用更大字号、更少文字以及超大触控按钮。",
    howKicker: "使用流程",
    howTitle: "三步从空白页到数据洞察。",
    howDesc: "无需代码、无需复杂设置——快速构建、分享并分析。",
    step1Title: "创建表单",
    step1Desc: "从模板或 AI 草稿开始，添加问题、分值和语言。",
    step2Title: "分享单一链接",
    step2Desc: "通过二维码、WhatsApp 或嵌入方式发送。手机端即点即用。",
    step3Title: "审核并跟进",
    step3Desc: "答案结构化进入管理后台，附带评分与分流状态。",
    adminKicker: "专为团队设计",
    adminTitle1: "高效管理后台，",
    adminTitle2: "推动工作流转。",
    adminDesc: "所有答卷汇总至清爽的工作区：搜索、筛选、更新分流状态并保持信息整洁。",
    adminB1: "所有提交汇总在单一表格",
    adminB2: "一键更新处理状态",
    adminB3: "安全重命名受访者",
    adminB4: "快速搜索与多重筛选",
    ...
    adminStat3: "平均分",
    closingBadge: "免费演示",
    closingTitle: "从客户视角体验 9forms.com。",
    closingDesc: "打开演示表单，用触控或语音作答，再走进管理后台查看这些答案的落脚处。",
    closingCta: "立即开始演示",
    footerNote: "9forms.com 智能表单构建平台。",
    footerOld: "诊所旧版落地页",
  },
};
